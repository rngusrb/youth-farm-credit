    ...
    try:
        ...
        if records:
            ...
            if current is not None:
                ...
                result = {"status": "ok", "source": "한국농수산식품유통공사 일별 중도매 가격정보", "crop": name, "match_level": "품목코드", "items": items[:5], "daily_series": series, "average_price": five_day_average, "average_label": "최근 5일 평균 도매가(상품·kg)"}
